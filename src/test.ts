...
await storage.setup();
const blobs = new DesktopBlobServer(storage, metadata);
...
archiver.addToQueue('b1674191a88ec5cdd733e4240a81803105dc412d6c6708d53ab94fc248f4f553', {
	servers: ['https://cdn.satellite.earth'],
});

// download pubkeys blobs
await archiver.queueBlobsFromPubkey('266815e0c9210dfa324c6cba3573b14bee49da4209a9456f9484e5106cd408a5', [
	'https://cdn.hzrd149.com',
	'https://cdn.satellite.earth',
]);
await archiver.queueBlobsFromPubkey('ff27d01cb1e56fb58580306c7ba76bb037bf211c5b573c56e4e70ca858755af0', [
	'https://cdn.satellite.earth',
	'https://cdn.hzrd149.com',
]);
